...
if(isset($_POST['add_image'])){
    ...
    $wpdb->query("insert into rowad_grid_images(image_url,show_img,link,language,type) values ('$uploaded_image', '1','".$_POST['link']."','".$_POST['lang']."','grid')");
...
$grid_images = $wpdb->get_results("select * from rowad_grid_images where type='grid' $where","ARRAY_A");
?>
<style>
.onoffswitch {
...
<div class="wrap">
    ...
    <h1>Offer Homepage Images</h1>
    <h3>Shortcode to use in page builders: [grid_images_offers]</h3>
